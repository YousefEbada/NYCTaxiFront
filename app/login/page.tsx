...
export default function LoginPage() {
  ...
  return (
    <div
      ...
      style={{ background: "#090514", fontFamily: "'Geist', 'Inter', sans-serif" }}
    >
          ...
          <form id="login-form" onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="operator@fleetcommand.nyc"
                className="w-full px-4 py-3 rounded-xl text-sm text-white placeholder-violet-900 outline-none transition-all duration-200"
                style={{
